/*
 * TWJYEngineResourceManagerPKH.h
 *
...
#include "header/TWJYEngineResourceManagerAPI.h"
#ifndef TWJYENGINERESOURCEMANAGERPKH_H_
#define TWJYENGINERESOURCEMANAGERPKH_H_
...
#endif /* TWJYENGINERESOURCEMANAGERPKH_H_ */
